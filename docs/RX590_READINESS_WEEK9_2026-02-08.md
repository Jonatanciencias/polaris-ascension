...
3. Falta validacion extendida de duracion (ventana wall-clock mas larga en Week10 Block1.4) antes de recomendacion de escalado amplio.

## Recommended Gate Before “Real Test Campaign”

1. Ejecutar Week10 Block1.4 con ventana extendida (`>=45 min` equivalente) manteniendo rollback SLA.
2. Mantener gate canonico obligatorio antes de cada promocion de alcance.
3. Ejecutar canary split Clover/rusticl con la politica endurecida antes de ampliar a entorno mas amplio.
