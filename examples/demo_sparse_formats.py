...
def demo_3_block_sparse():
    ...
    for bs in block_sizes:
        ...
        print(f"  Block size {bs}×{bs} ({bs**2} elements): "
...
def demo_4_format_comparison():
    ...
    formats = [
        ...
        ('CSR', csr.memory_footprint()['total_sparse'], csr.memory_footprint()['compression_ratio']),
        ('CSC', csc.memory_footprint()['total_sparse'], csc.memory_footprint()['compression_ratio']),
        ('Block-sparse 8×8', bsm8.memory_footprint()['total_sparse'], bsm8.memory_footprint()['compression_ratio']),
        ('Block-sparse 16×16', bsm16.memory_footprint()['total_sparse'], bsm16.memory_footprint()['compression_ratio']),
    ]
...
def demo_5_neural_network_combined():
    ...
    print(f"  Memory saved: {(total_mem_dense - total_mem_sparse)/1024/1024:.2f} MB ({(1-total_mem_sparse/total_mem_dense)*100:.1f}%)")
    print()
...
def demo_6_integration_with_pruning():
    ...
    for sparsity in sparsities:
        ...
        print(f"  {sparsity*100:>8.0f}% {format_name:>15} {mem/1024:>10.2f} KB {compression:>10.2f}x")
