...
class OpenCLKernelBenchmark:
    ...
    def run_comparison(self, sizes: List[int] = [256, 512, 1024]) -> Dict:
        ...
        for size in sizes:
            ...
            # Naive
            try:
                r = self._benchmark_kernel(self.prog_naive, 'gemm_naive', 
            ...
            # Tiled
            try:
                r = self._benchmark_kernel(self.prog_tiled, 'gemm_tiled',
                                          size, size, size, (16, 16))
            ...
            # Optimized
            try:
                r = self._benchmark_kernel(self.prog_opt, 'gemm_optimized',
                                          size, size, size, (8, 32))
    ...
    def _print_summary(self, results: Dict):
        ...
        print(f"🎯 Meta +20-30%: {'✅ SUPERADA' if avg_improvement >= 30 else '✅ CUMPLIDA' if avg_improvement >= 20 else '❌ No alcanzada'}")
