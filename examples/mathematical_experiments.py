...
def demo_genomic_ranking():
    ...
    for bits in [32, 16, 8]:
        ...
        print(f"  Safe for Variant Calling: {'✅ Yes' if result['is_safe_for_genomics'] else '❌ No'}")
...
def demo_protein_structure_sparsity():
    ...
    results = sparse_net.test_protein_structure_prediction(
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--no-pause',
        action='store_true',
        help='Run all demos without pausing'
    )
