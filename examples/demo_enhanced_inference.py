...
def demo_1_model_compression():
    ...
    for desc, result in results:
        print(f"{desc:<35} {result.compression_ratio:>10.2f}x "
...
def demo_2_adaptive_batching():
    ...
    def callback(response: BatchResponse):
        ...
        print(f"  ✓ Request {response.request_id[:12]}... processed "
...
def demo_3_multi_model_serving():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print(f"  Memory Used: {server_stats['total_memory_mb']:.1f} MB / "
        ...
        for model_name, _ in model_configs:
            ...
            if stats:
                print(f"{model_name:<20} {stats.total_requests:>10} "
