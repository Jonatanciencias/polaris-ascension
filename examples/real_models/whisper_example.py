...
def main():
    ...
    whisper = create_whisper_integration(quantization_mode="int8", optimization_level=2)
    ...
    audio_examples = [
        {"name": "English Speech", "language": "en", "task": "transcribe"},
        {"name": "Spanish Speech", "language": "es", "task": "transcribe"},
        {
    ...
    for i, config in enumerate(audio_examples, 1):
        ...
        # Transcribe
        text = whisper.transcribe(audio=audio, language=config["language"], task=config["task"])
