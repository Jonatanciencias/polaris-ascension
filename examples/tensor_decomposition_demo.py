...
def demo_full_model_decomposition():
    ...
    config = DecompositionConfig(method="tucker", auto_rank=True, energy_threshold=0.95)
    ...
    config2 = DecompositionConfig(method="tucker", ranks=[8, 16], auto_rank=False)
...
def demo_resnet_compression():
    ...
    config = DecompositionConfig(method="tucker", ranks=[16, 32], auto_rank=False)
...
def demo_comparison_table():
    ...
    configs = [
        ...
        (
            "Tucker (Auto-rank 0.95)",
            DecompositionConfig(method="tucker", auto_rank=True, energy_threshold=0.95),
        ),
        (
            "Tucker (Auto-rank 0.90)",
            DecompositionConfig(method="tucker", auto_rank=True, energy_threshold=0.90),
        ),
