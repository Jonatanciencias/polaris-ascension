...
class TestPerformanceIntegration:
    ...
    def test_sustained_throughput(self, integrated_engine):
        ...
        assert trimmed_cv < 0.30, f"Variación sostenida (trimmed CV) {trimmed_cv:.2%} es muy alta"
        assert raw_cv < 0.60, f"Variación bruta (raw CV) {raw_cv:.2%} indica inestabilidad severa"
