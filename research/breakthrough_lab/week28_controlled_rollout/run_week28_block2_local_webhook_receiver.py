#!/usr/bin/env python3
"""Local webhook receiver for Week28 Block2 observability validation."""
...
class _WebhookHandler(BaseHTTPRequestHandler):
    server_version = "Week28WebhookReceiver/1.0"
...
def main() -> int:
    ...
    parser.add_argument(
        "--output-json",
        default="research/breakthrough_lab/week28_controlled_rollout/week28_block2_live_webhook_capture.json",
    )
