...
- Date: 2026-02-08T18:36:51.602567+00:00
...
| t3 | block10 | 827.069 | 14.145 | 0.0005493 | fallback=0.0000, disabled=0 |
...
| t5 | block10 | 831.262 | 13.997 | 0.0005798 | overhead=1.902%, disable=2 |
...
| t3 | block6 -> block10 | +0.413 | -0.037 | fallback_delta=+0.0000 |
...
| t5 | block6 -> block10 | -1.362 | +0.075 | overhead_delta=+0.294%, disable_delta=2 |
...
- Dashboard status: `iterate`
- Rationale: One or more active stages are not in promote state.
