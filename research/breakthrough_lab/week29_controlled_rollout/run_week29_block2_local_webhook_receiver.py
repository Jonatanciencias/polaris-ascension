#!/usr/bin/env python3
"""Local webhook receiver for Week29 Block2 observability validation."""
...
class _WebhookHandler(BaseHTTPRequestHandler):
    server_version = "Week29WebhookReceiver/1.0"
...
def main() -> int:
    ...
    parser.add_argument(
        "--output-json",
        default="research/breakthrough_lab/week29_controlled_rollout/week29_block2_live_webhook_capture.json",
    )
