#!/usr/bin/env python3
"""Local webhook receiver for Week30 Block2 observability validation."""
...
class _WebhookHandler(BaseHTTPRequestHandler):
    server_version = "Week30WebhookReceiver/1.0"
...
def main() -> int:
    ...
    parser.add_argument(
        "--output-json",
        default="research/breakthrough_lab/week30_controlled_rollout/week30_block2_live_webhook_capture.json",
    )
