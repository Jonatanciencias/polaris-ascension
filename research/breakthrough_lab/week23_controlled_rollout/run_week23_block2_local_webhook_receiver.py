#!/usr/bin/env python3
"""Local webhook receiver for Week23 Block2 hardening validation."""
...
class _WebhookHandler(BaseHTTPRequestHandler):
    server_version = "Week23WebhookReceiver/1.0"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run local webhook receiver with configurable transient failures.")
    parser.add_argument("--host", default="127.0.0.1")
    parser.add_argument("--port", type=int, default=8775)
    parser.add_argument(
        "--output-json",
        default="research/breakthrough_lab/week23_controlled_rollout/week23_block2_live_webhook_capture.json",
    )
