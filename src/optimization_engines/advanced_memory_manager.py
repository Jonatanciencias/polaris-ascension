...
class TilingManager:
    ...
    def load_tile(
        ...
        tile_data = matrix[tile.row_start:tile.row_end, 
                          tile.col_start:tile.col_end].copy()
        ...
        buf = self.buffer_pool.get_buffer(
...
class AdvancedMemoryManager:
    ...
    def __init__(
        ...
        self.buffer_pool = AdvancedBufferPool(
            context=context,
            queue=queue,
            max_pool_memory=max_gpu_memory // 2  # 50% para pool
        )
